...
<ul>
  ...
  <li><p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to DXG(Digital Xpreince Group, Land O&#39; Lakes, Florida.</p></li>
  ...
  <li><p><strong>Country</strong> refers to: Florida, United States</p></li>
  ...
  <li><p><strong>Website</strong> refers to DXG(Digital Xpreince Group), accessible from <a href="https://dxg-website.vercel.app/" target="_blank" rel="external nofollow noreferrer">https://dxg-website.vercel.app/</a></p></li>
...
<ul>
  <li>Address: <strong>12824 Dupont Circle Tampa, FL 33626</strong></li>
  <li>Phone: <strong>855.282.9394</strong></li>
  <li>Email: <strong>Info@dxg.agency</strong></li>
</ul>
`,
};
...
export const termsOfUsePage: LegalPageContent = {
  ...
  contentHtml: `
<h1>Terms of Use</h1>
<h2>Welcome to DXG!</h2>
<p>These terms and conditions outline the rules and regulations for the use of DXG(Digital Xpreince Group&#39;s Website, located at https://dxg-website.vercel.app/.</p>
<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use DXG if you do not agree to take all of the terms and conditions stated on this page.</p>
...
<h3>Cookies</h3>
<p>We employ the use of cookies. By accessing DXG, you agreed to use cookies in agreement with the DXG(Digital Xpreince Group&#39;s Privacy Policy.</p>
<p>Most interactive websites use cookies to let us retrieve the user&#39;s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>
<h3>License</h3>
<p>Unless otherwise stated, DXG(Digital Xpreince Group and/or its licensors own the intellectual property rights for all material on DXG. All intellectual property rights are reserved. You may access this from DXG for your own personal use subjected to restrictions set in these terms and conditions.</p>
<p>You must not:</p>
<ul>
...
<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. DXG(Digital Xpreince Group does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of DXG(Digital Xpreince Group,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, DXG(Digital Xpreince Group shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
<p>DXG(Digital Xpreince Group reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
...
<p>You hereby grant DXG(Digital Xpreince Group a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
...
<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of DXG(Digital Xpreince Group; and (d) the link is in the context of general resource information.</p>
<p>These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party&#39;s site.</p>
<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to DXG(Digital Xpreince Group. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
...
<p>No use of DXG(Digital Xpreince Group&#39;s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
<h3>iFrames</h3>
