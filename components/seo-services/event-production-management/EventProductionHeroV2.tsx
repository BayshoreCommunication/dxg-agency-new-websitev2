        ...
        <div className="max-w-[1180px] mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 xl:col-span-7">
              ...
              {/* H1 Heading */}
              <h1 className="text-3xl sm:text-5xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white leading-[1.1] mb-6 font-['Josefin_Sans',sans-serif]">
                One production plan. One team looking at the entire event.
              </h1>

              {/* Lede text */}
              <p className="text-base sm:text-lg lg:text-[19px] leading-relaxed text-[#C9D3DC] mb-8 font-['IBM_Plex_Sans',sans-serif] max-w-[62ch]">
                A conference runs on hundreds of production decisions. Budget,
                venue, vendors, content, labor, rehearsals and show flow. DXG
                connects them in a single execution plan, from early planning
                through show day, whether the equipment comes from DXG, the
                venue or another vendor. You keep ownership of the event
                strategy.
              </p>
