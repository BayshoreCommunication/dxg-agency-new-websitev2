        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="text-[#C9D3DC] max-w-[56ch] leading-relaxed font-['IBM_Plex_Sans',sans-serif] text-base sm:text-lg">
              The right production structure gives meeting planners better
              control over decisions, spending and execution. Tell us about
              your event and start the conversation with a production team
              focused on the full program.
            </p>
          </div>
