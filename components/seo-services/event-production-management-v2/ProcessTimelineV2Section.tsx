        ...
        <div className="relative mt-24">
          ...
          <ol className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-0">
            {steps.map((step) => (
              <li
                key={step.num}
                className="group relative list-none pr-0 lg:pr-[22px] pt-[10px] transition-all duration-300 hover:-translate-y-1"
              >
                {/* Ghost numeral */}
                <span
                ...
                <p className="text-[14.5px] text-[#C9D3DC] leading-relaxed font-['IBM_Plex_Sans',sans-serif]">
                  {step.desc}
                </p>
              </li>
            ))}
